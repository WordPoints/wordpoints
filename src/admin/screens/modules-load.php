...
$screen->add_help_tab(
	array(
		...
		'content'	=>
			...
			'<p>' . wp_kses( sprintf( __( 'If something goes wrong with a module and you can&#8217;t use WordPoints, delete or rename that file in the <code>%s</code> directory and it will be automatically deactivated.', 'wordpoints' ), wordpoints_modules_dir() ), array( 'code' => true ) ) . '</p>'
	)
);
