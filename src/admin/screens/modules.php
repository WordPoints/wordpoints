		...
		if (
			...
			<div id="message" class="error">
				<p>
					...
					<iframe style="border:0" width="100%" height="70px" src="admin.php?page=wordpoints_modules&action=error_scrape&amp;module=<?php echo esc_attr( sanitize_text_field( $_GET['module'] ) ); ?>&amp;_wpnonce=<?php echo esc_attr( sanitize_text_field( $_GET['_error_nonce'] ) ); ?>"></iframe>
				</p>
			</div>
...
<div class="wrap">
	<h2>
		...
		<?php if ( ! empty( $_REQUEST['s'] ) ) : ?>
			<span class="subtitle"><?php echo esc_html( sprintf( __( 'Search results for &#8220;%s&#8221;', 'wordpoints' ), sanitize_text_field( $_REQUEST['s'] ) ) ); ?></span>
		<?php endif; ?>
	</h2>
