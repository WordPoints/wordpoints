...
/**
 * Test case for WordPoints_Hook_Condition_Number_Greater_Than.
 *
...
/**
 * Tests WordPoints_Hook_Condition_Number_Greater_Than.
 *
 * @since 2.3.0
 *
 * @covers WordPoints_Hook_Condition_Number_Greater_Than
 */
class WordPoints_Hook_Condition_Number_Greater_Than_Test
	...
	public function test_is_met( $value, $compare ) {
		...
		$condition = new WordPoints_Hook_Condition_Number_Greater_Than();
