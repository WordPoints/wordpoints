...
/**
 * Testcase for WordPoints_Module_Server_API_Module_Data.
 *
...
/**
 * Test WordPoints_Module_Server_API_Module_Data.
 *
 * @since 2.4.0
 *
 * @group modules
 *
 * @covers WordPoints_Module_Server_API_Module_Data
 */
class WordPoints_Module_Server_API_Module_Data_Test extends WordPoints_PHPUnit_TestCase {
	...
	public function test_get_id() {
		...
		$server = $this->getMock( 'WordPoints_Module_ServerI' );

		$data = new WordPoints_Module_Server_API_Module_Data( $id, $server );
	...
	public function test_get() {
		...
		update_site_option(
			"wordpoints_module_data-{$server_slug}-{$id}"
			, array( 'test' => 'a' )
		);
	...
	public function test_set() {
		...
		$id = '45';
		$server_slug = 'example.com';
		$option = "wordpoints_module_data-{$server_slug}-{$id}";
