...
/**
 * Test case for WordPoints_Points_Logs_Viewing_Restriction_Read_Comment_Post.
 *
...
/**
 * Tests WordPoints_Points_Logs_Viewing_Restriction_Read_Comment_Post.
 *
 * @since 2.2.0
 *
 * @covers WordPoints_Points_Logs_Viewing_Restriction_Read_Comment_Post
 */
class WordPoints_Points_Logs_Viewing_Restriction_Read_Comment_Post_Test
	...
	public function test_get_description() {
		...
		$restriction = new WordPoints_Points_Logs_Viewing_Restriction_Read_Comment_Post(
			$log
		);
	...
	public function test_applies_nonexistent() {
		...
		$log = $this->factory->wordpoints->points_log->create_and_get(
			array( 'log_meta' => array( 'comment_id' => 'a' ) )
		);
